...
export const STEAM_STARTERS: SteamStarter[] = [
  // ── R'z Lab. 2026 ──────────────────────────────────────────────────────────
  {
    title: "アナログフィルムカメラで撮る",
    ageBand: "R'z Lab. 2026",
    icon: "📷",
    learn: "光、露出、構図、アナログ表現",
    prompt:
      "今日はアナログフィルムカメラで撮影する体験をしました。撮影する前にどんな写真を撮りたいと考えましたか？光の当たり方や構図で何を工夫しましたか？デジタルカメラとの違いで気づいたことを教えてください。一緒に今日の体験を振り返りましょう。",
  },
  {
    title: "HITEM3Dでモデリング＆3Dプリント",
    ageBand: "R'z Lab. 2026",
    icon: "🖨️",
    learn: "3Dモデリング、立体思考、設計、製造",
    prompt:
      "今日はHITEM3Dで3Dモデリングをして、3Dプリンターで出力する体験をしました。頭の中のイメージを立体にするとき、どんなことが難しかったですか？実際に印刷されたものを見てどう感じましたか？設計と製造の間で気づいたことを一緒に振り返りましょう。",
  },
  {
    title: "RorkでAIと対話しながらアプリ制作",
    ageBand: "R'z Lab. 2026",
    icon: "🤖",
    learn: "AI対話、アプリ設計、プロンプト、創造的思考",
    prompt:
      "今日はRorkを使ってAIと対話しながらアプリを作りました。AIに何をお願いしましたか？思い通りにいったこと・いかなかったことはありましたか？AIと一緒に作ることで、自分一人で作るときと何が違うと感じましたか？今日の体験を一緒に振り返りましょう。",
  },
  // ── 汎用 STEAM スターター ──────────────────────────────────────────────────
  {
    title: "音に反応する光のアート",
